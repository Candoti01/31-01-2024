...
import controller.InterfacePadoka;
...
public class CardapioModel {
    ...
    public static void exibirCardapio() {
        ...
        try {
            ...
            String strSqlSelectReceitas = "select * from `mysql_connector`.`tbl_receitas`;";
            ...
            while (rsSqlReceitas.next()) {
                ...
                strSqlSelectItensReceita = "select * from `mysql_connector`.`tbl_itens_receita` where `id_receita` = " + idReceita + ";";
                ...
                while (rsSqlItensReceitas.next()) {
                    ...
                    strSqlSelectProdutosReceita = "select * from `mysql_connector`.`tbl_produtos` where `id` = " + idProdutoReceita;
                ...
                if (receitaDisponivel == true) {
                    InterfacePadoka.resultadoModelDisponivel += "-=-[" + numReceita + "] - " + nomeReceita + " - disponível.-=-\n";
                } else {
                    InterfacePadoka.resultadoModelDisponivel += "-=-[" + numReceita + "] - " + nomeReceita + " - indisponível.-=-\n";
                }
                numReceita++;
